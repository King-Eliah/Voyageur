...
export default function UpcomingBookingsScreen() {
  ...
  // Get upcoming bookings (after today and not cancelled)
  ...
  }, [upcomingBookings, searchQuery, statusFilter, typeFilter]);
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>Upcoming Bookings</Text>
      </View>
      ...
      {filteredBookings.length > 0 ? (
        ...
        <View style={[styles.emptyState, { backgroundColor: colors.card }]}>
          ...
          <Text style={[styles.emptyTitle, { color: colors.text }]}>
            {searchQuery || statusFilter || typeFilter ? 'No matching bookings' : 'No Upcoming Bookings'}
          </Text>
